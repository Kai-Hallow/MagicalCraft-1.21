...
import net.kaihallow.magicalcraft.events.ItemInteractHandler;
...
public class MagicalCraft
{
    ...
    public static final String MODID = "magicalcraft";
    ...
    public MagicalCraft()
    {
        ...
        MinecraftForge.EVENT_BUS.register(new ItemInteractHandler());
